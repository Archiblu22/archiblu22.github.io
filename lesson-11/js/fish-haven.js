const apiURL = 'https://api.openweathermap.org/data/2.5/weather?lat=42.0380399&lon=-111.4048681&appid=5a8b6d64355815c5601d192328cda6b0&units=imperial';
fetch(apiURL)
...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?lat=42.0380399&lon=-111.4048681&units=imperial&appid=5a8b6d64355815c5601d192328cda6b0';
fetch(forecastURL)
    .then((response) => response.json())
    .then((forecastObject) => {
